...
const TimeCalculator = ({ name, heading, description }) => {
  ...
  useEffect(() => {
    ...
    if (
      timeCalculationData.day &&
      timeCalculationData.month &&
      timeCalculationData.year
    ) {
      calculateTime(
        name,
        setResult,
  ...
  const weekdayText =
    name === "time passed" ? "It all began on a:" : "It will happen on a:"
      ...
      <form className="form">
        ...
        <div className="inner-wrapper space-between">
          ...
          <Select
            ...
            handleChange={(e) =>
              handleChange(e, "month", setTimeCalculationData)
            }
        ...
        <div className="inner-wrapper space-between">
          ...
          <Input
            ...
            handleChange={(e) =>
              handleChange(e, "year", setTimeCalculationData)
            }
          />
        </div>
        <div className="inner-wrapper">
          <label htmlFor={`${name}-checkbox`} className="label--visible">
        ...
        <div className="inner-wrapper space-between result-wrapper">
          {isError && (
            <p className="p--large p--warning">
              {isProcessing ? "One moment please..." : errorMessage}
            </p>
          )}
          {!isError && !isDetailsSelected && (
            <p className="p--large">Result:</p>
          )}
          {result && !isDetailsSelected && !isError && (
            <p className="p--large">{result.years} years</p>
          )}
